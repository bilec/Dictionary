...
public class HistoryGlobalFragment extends Fragment {

    private FragmentHistoryListBinding binding;
    private HistoryGlobalViewModel historyGlobalViewModel;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        historyGlobalViewModel = new ViewModelProvider(this).get(HistoryGlobalViewModel.class);
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId())
        {
            case R.id.history_button_time:
            {
                historyGlobalViewModel.getAllWords().observe(getViewLifecycleOwner(), observer);
            ...
            case R.id.history_button_alphabetically_az:
            {
                historyGlobalViewModel.getAlphabetizedAscWords().observe(getViewLifecycleOwner(), observer);
            ...
            case R.id.history_button_alphabetically_za:
            {
                historyGlobalViewModel.getAlphabetizedDescWords().observe(getViewLifecycleOwner(), observer);
            ...
            case R.id.history_button_delete_all:
            {
                new MaterialAlertDialogBuilder(requireContext())
                        ...
                        .setPositiveButton(R.string.delete, (dialogInterface, i) -> historyGlobalViewModel.deleteAll())
    ...
    private static final String SELECTED_SORT_BY_BUTTON = "SELECTED_SORT_BY_BUTTON_GLOBAL";
